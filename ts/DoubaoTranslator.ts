...
const ENDPOINTS: Record<string, string> = {
    general: 'https://ark.cn-beijing.volces.com/api/v3/chat/completions',
    coding: 'https://ark.cn-beijing.volces.com/api/coding/v3/chat/completions'
};

export class DoubaoTranslator {
